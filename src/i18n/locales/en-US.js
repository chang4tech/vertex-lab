export default {
  ...
  'plugins.close': 'Close plugins manager',
  // Plugin Control Hub
  ...
  'plugin.error.title': 'Something went wrong',
  'plugin.error.details': 'Error details',
  'plugin.error.retry': 'Try Again',
  'plugin.error.dismiss': 'Dismiss',
  ...
  'plugin.gamification.name': 'Gamification Boost',
  'plugin.gamification.description': 'Track XP, streaks, and badges as you map ideas.',
  'plugin.paperProspector.name': 'Paper Reference Prospector',
  'plugin.paperProspector.description': 'Scout related references with configurable graph depth.',
  'plugin.connectNodesById.prompt': 'Enter target node ID to connect/disconnect:',
  'plugin.connectNodesById.notFound': 'Node not found. Check the ID and try again.',
  'plugin.connectNodesById.self': 'Cannot connect a node to itself.',
  ...
  'plugin.followUpReminders.title': 'Follow-up Reminders',
  'plugin.followUpReminders.desc': 'Track follow-up dates for nodes and highlight what needs attention.',
  'plugin.followUpReminders.highlightDue': 'Highlight due',
  'plugin.followUpReminders.selectDue': 'Select due',
  'plugin.followUpReminders.currentNode': 'Reminder for: {name}',
  'plugin.followUpReminders.noNode': 'Select a node to schedule follow-up.',
  'plugin.followUpReminders.dueLabel': 'Follow-up date',
  'plugin.followUpReminders.noteLabel': 'Notes (optional)',
  'plugin.followUpReminders.save': 'Save reminder',
  'plugin.followUpReminders.clear': 'Clear',
  'plugin.followUpReminders.upcoming': 'Upcoming follow-ups',
  'plugin.followUpReminders.none': 'No follow-ups scheduled.',
  'plugin.followUpReminders.invalidShort': 'Invalid date',
  'plugin.followUpReminders.overdue': 'Overdue',
  'plugin.followUpReminders.dueSoon': 'Due soon',
  'plugin.followUpReminders.scheduled': 'Scheduled',
  'plugin.followUpReminders.openNode': 'Focus node',
  'plugin.followUpReminders.markDone': 'Mark done',
  'plugin.followUpReminders.invalidDate': 'Enter a valid follow-up date and time.',
  'plugin.followUpReminders.overlayLabel': '{count, plural, one {# follow-up due soon} other {# follow-ups due soon}}',
  'plugin.followUpReminders.openPanel': 'Review reminders',
  'plugin.followUpReminders.log.invalid': 'Skipped reminder save for {name}: invalid date.',
  'plugin.followUpReminders.log.saved': 'Saved reminder for {name} due {date}.',
  'plugin.followUpReminders.log.cleared': 'Cleared reminder for {name}.',
  'plugin.followUpReminders.log.selectDue': 'Selected {count, plural, one {# due node} other {# due nodes}}.',
  'plugin.followUpReminders.log.highlightDue': 'Highlighted {count, plural, one {# due node} other {# due nodes}}.',
  'plugin.followUpReminders.log.focus': 'Focused reminder node {name}.',
  'plugin.followUpReminders.log.openHub': 'Opened reminder list from overlay.',
  'plugin.followUpReminders.statusSaved': 'Reminder saved.',
  'plugin.followUpReminders.statusCleared': 'Reminder cleared.',
  'plugin.followUpReminders.statusInvalid': 'Enter a valid follow-up date before saving.',
  ...
  'plugin.followUpReminders.currentNote': 'Notes: {note}',
  'plugin.followUpReminders.currentNoNote': 'No notes added.',
  'plugin.followUpReminders.unknownNode': 'Node {id}',
  'plugin.levels.title': 'Levels',
  'plugin.levels.prompt': 'Enter level for node:',
  'plugin.levels.invalid': 'Level must be a valid number.',
